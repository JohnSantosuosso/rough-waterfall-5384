...
RSpec.describe 'Customer Show Page' do
  it 'shows all customers and their items' do
  ...
  it 'shows the supermarket the customer is associated with' do
    supermarket_1 = Supermarket.create!(id: 1, name: 'Giant', location: "Denver")
    supermarket_2 = Supermarket.create!(id: 2, name: 'Safeway', location: "Tampa")
  ...
  it 'shows the total price of all a customers items' do
    supermarket_1 = Supermarket.create!(id: 1, name: 'Giant', location: "Denver")
    supermarket_2 = Supermarket.create!(id: 2, name: 'Safeway', location: "Tampa")
